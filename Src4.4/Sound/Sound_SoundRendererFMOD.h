...
#if defined(SF_OS_WIN32) && !defined(SF_OS_WINMETRO) && !defined(SF_OS_DURANGO)
#if defined(_WIN64)         // Windows PC x64/x86
    #pragma comment(lib, "fmodex64_vc.lib")
#else
    #pragma comment(lib, "fmodex_vc.lib")
#endif
#elif defined(SF_OS_WINMETRO) && !defined(SF_OS_DURANGO)
#if WINAPI_FAMILY == WINAPI_FAMILY_PHONE_APP
	#if (SF_CC_MSVC == 1700)
		#if defined(_M_ARM_FP)  // Windows Phone8 ARM/x86
		#pragma comment(lib, "fmodex_80_arm.lib")
		#else
		#pragma comment(lib, "fmodex_80_x86.lib")
		#endif
	#endif
	#if (SF_CC_MSVC == 1800)
		#if defined(_M_ARM_FP)  // Windows Phone8 ARM/x86
		#pragma comment(lib, "fmodex_81_arm.lib")
		#else
		#pragma comment(lib, "fmodex_81_x86.lib")
		#endif
	#endif
	
#else
#if ((SF_CC_MSVC == 1700) && !defined(SF_OS_DURANGO)) //Windows 8
